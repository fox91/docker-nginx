...
docker tag -f fox91/nginx:latest docker.io/fox91/nginx:1.9.10
...
docker tag -f fox91/nginx:profpm docker.io/fox91/nginx:1.9.10-profpm
...
docker tag -f fox91/nginx:profpm-catchall docker.io/fox91/nginx:1.9.10-profpm-catchall
...
docker tag -f fox91/nginx:ssl docker.io/fox91/nginx:1.9.10-ssl
...
docker tag -f fox91/nginx:ssl-profpm docker.io/fox91/nginx:1.9.10-ssl-profpm
...
docker tag -f fox91/nginx:ssl-profpm-catchall docker.io/fox91/nginx:1.9.10-ssl-profpm-catchall
